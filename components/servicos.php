...
<div class="popup hidden" id="servico-popup">
    ...
    <div id="sites" class="hidden" style="width: fit-content; margin: 0 auto; padding: 0 8%;">
        ...
        <p class="texto">Criamos layouts personalizados de alto padrão que não apenas
            impressionam
    ...
    <!-- Popup serviço: DESENVOLVIMENTO DE SOFTWARES -->
    <div id="softwares" class="hidden" style="width: fit-content; margin: 0 auto; padding: 0 8%;">

        <h2 class="title">Desenvolvimento de softwares</h2>

        <p class="texto">Nossos softwares são projetados e desenvolvidos para atender às
